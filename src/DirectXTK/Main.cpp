...
int Main(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"CreaDXTKLibWindowClass";
        ...
        HWND hwnd = CreateWindowEx(0, L"CreaDXTKLibWindowClass", L"CreaDXTKLib", WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // TODO: Change to CreateWindowEx(WS_EX_TOPMOST, L"CreaDXTKLibWindowClass", L"CreaDXTKLib", WS_POPUP,
